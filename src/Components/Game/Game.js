                ...
                <div className="form-container">
                    <form className="form-input">
                        ...
                        <div>
                            ...
                            <input className="game-input" type="text" value={releaseDate} name="releaseDate" onChange={e => setReleaseDate(e.target.value)} />
                        </div>
                        <label type="text" name="release-date">Enter Game Platforme</label>
                        <input className="game-input" type="text" value={platform} name="platform" onChange={e => setPlatform(e.target.value)} />
                        <div>
                            <label type="text" name="release-date">Enter Game Release Date</label>
                            <input className="game-input" type="text" value={releaseDate} name="release" onChange={e => setReleaseDate(e.target.value)} />
                        </div>
                        <div>
                            <label type="text" name="developer">Enter Game Developer</label>
                            <input className="game-input" type="text" value={developer} name="developer" onChange={e => setDeveloper(e.target.value)} />
                        </div>
                        <div>
                            <label type="text" name="rating">Enter Game Age Rating</label>
                            <input className="game-input" type="text" value={rating} name="rating" onChange={e => setRating(e.target.value)} />
                        </div>
                        <div>
                            <label type="text" name="select-image">Select Image</label>
                            <input className="select-button" type="file" onChange={saveFile}></input>
                        </div>
