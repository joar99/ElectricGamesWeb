...
export default function AddDev() {
  ...
  const postDev = async () => {
    await axios
      .post(devControllerUrl, JSON.stringify(dev), {
        headers: {
      ...
      <section className="container">
        <div className="form">
          <form className="form-input">
            <div>
              <label className="add-label" type="text" name="dev-name">
            ...
            <div>
              <label className="add-label" type="text" name="dev-location">
                Enter Developer Location
              </label>
              <input
                className="add-input"
                type="text"
