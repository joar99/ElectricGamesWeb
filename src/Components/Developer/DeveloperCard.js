                ...
                <div className="card-overlay">
                    <ul class="card-overlay_list">
                        ...
                        <ul class="card-overlay-buttons">
                            <li><Link className="edit-link" to={`/developers/${developer.id}`}>Edit Developer</Link></li>
    ...
    return (
        <>
            <div className="popup-container-delete">
                ...
                <DeleteDev className="delete-btn" onDeleteDev={onDeleteDev} idToDelete={developer.id} handleChangePopup={handleChangePopup}></DeleteDev>
            </div>
        </>
    )
