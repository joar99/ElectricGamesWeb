  ...
  return (
    <>
      ...
      <section className="start-btn-container">
        <button className="start-btn" onClick={onChange}>
          Start Game
        </button>
      </section>
    </>
...
const PlayMemory = ({ onChange }) => {
  ...
  const characterRandomUrl =
    "https://localhost:7127/api/Characters/randomizefour";

  useEffect(() => {
    axios
      .get(characterRandomUrl)
      .then((response) => {
      ...
      {memoryIsActive === true ? (
            ...
            <div className="information-container">
              ...
              <div className="characater-choice-container">
                {memory.map((memory) => {
                  return (
                    <button
                      className="character-memory-btn"
              ...
              <div className="btn-container">
                ...
                <button className="end-btn" onClick={onChange}>
                  End Game
                </button>
              </div>
            </div>
        ...
        <>
          ...
          <section className="end-btn-container">
            <button className="end-game-btn" onClick={onChange}>
              Yes!
            </button>
          </section>
        </>
...
const CorrectCharacter = (props) => {
  return (
    <img
      src={`https://localhost:7127/images/${encodeURIComponent(props.image)}`}
      alt={`https://localhost:7127/images/placeholder.png`}
