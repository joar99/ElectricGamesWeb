...
export default function CharacterCard({ character, setDeleteCharacterFlag }) {
    ...
    const backgroundLink = `https://localhost:7127/images/${encodeURIComponent(character.image)}`
                ...
                <div className="card-overlay">
                    <ul class="card-overlay_list">
                        ...
                        <ul class="card-overlay-buttons">
                            <li><Link className="edit-link" to={`/characters/${character.id}`}>Edit Character</Link></li>
